...
def data_analysis():
    df = pd.read_csv(r'C:\Users\vansh\Downloads\DAML_CODING\DAML_CODING\Houseprice_streamlit\house_price_prediction_dataset.csv')
...
def internship():
    ...
    st.write('Student Name: Vansh Gondalia')
    st.write('Student ID: 211310132026')
    st.write('Program: Information and Communication Technology')
    st.write('University: Gujarat Technological University')
    st.write('Contact Email: vansh107711@gmail.com')
...
if choose == "About":
    ...
    df = pd.read_csv('C:/Users/vansh/Downloads/DAML_CODING/DAML_CODING/Houseprice_streamlit/house_price_prediction_dataset.csv')
    st.title("DATAFRAME")
    st.dataframe(df)
